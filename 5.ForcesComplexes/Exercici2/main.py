...
center_ball = Ball(10, np.power(10, 14), [400, 300], [0, 0])
center_ball.apply_force([0,0])

ball1 = Ball(20, 10, [150, 200], [4, 1])
ball2 = Ball(20, 10, [650, 200], [-2, 3])
ball3 = Ball(20, 10, [450, 100], [-5, 2])
ball4 = Ball(20, 10, [250, 550], [1, -2])
